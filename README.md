# Functional Python [![](https://github.com/kamyal/functional-python/workflows/tests/badge.svg)](https://github.com/kamyal/functional-python/actions?query=workflow%3Atests)
